      ...
      <ul className="no-list ">
        {Object.keys(data).map((item, i) => (
          <li
            ...
            className={`${selectedCountry === item ? 'bg-cyan-400 text-white' : ''} w-[100%] mt-4 h-[40px] flex items-center font-poppins border-[2px] px-1 rounded-md hover:bg-cyan-300 active:bg-cyan-500 hover:text-white hover:border-0 cursor-pointer`}>
            {item}
          </li>
        ))}
      </ul>
